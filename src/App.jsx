...
function App() {
  ...
  >
    <div className="bg-slate-800/70 rounded-xl p-8 max-w-md w-full shadow-2xl text-white text-center transform transition-transform duration-300 ease-in-out animate-slideUp">
      <h2 id="logout-modal-title" className="text-3xl font-bold mb-4 select-none">
        Confirm Logout
      </h2>
      <p id="logout-modal-description" className="mb-6 text-lg select-none">
        Are you sure you want to logout?
      </p>
      <div className="flex justify-center gap-6">
        <button
          onClick={handleLogoutConfirm}
          className="px-6 py-3 rounded-lg font-semibold shadow-lg text-white bg-gradient-to-r from-teal-800 to-teal-200 hover:from-teal-200 hover:to-teal-800 focus:outline-none focus:ring-4 focus:ring-teal-400 focus:ring-opacity-70 transition duration-300 ease-in-out transform hover:scale-105"
        >
          Yes, Logout
        </button>
        ...
        <button
          ...
          className="px-6 py-3 rounded-lg font-semibold shadow-lg text-white bg-gradient-to-r from-orange-800 to-orange-200 hover:from-orange-200 hover:to-orange-800 focus:outline-none focus:ring-4 focus:ring-orange-400 focus:ring-opacity-70 transition duration-300 ease-in-out transform hover:scale-105"
        >
          Cancel
        </button>
      </div>
